...
gulp.task('build', function (done) {
  runSequence(['clean'], ['build:js', 'build:vendor-js', 'build:es6-js', 'build:css', 'build:assets', 'build:config', 'build:svg'], ['output:errors'], done);
});

gulp.task('build:zip', function (done) {
  runSequence(['clean'], ['build:js', 'build:vendor-js', 'build:es6-js', 'build:css', 'build:assets', 'build:svg'], done);
});
